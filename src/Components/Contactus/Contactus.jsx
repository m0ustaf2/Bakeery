    ...
    <>
      <div className="container-fluid">
        <div className="header">
          <h1 className={`text-center main-color my-5 h-cont ${style.head}`}>
            Contact us
          </h1>
        </div>
        <div className="d-flex justify-content-center">
          ...
          <div className="col-sm-6 col-md-6 col-xl-6 col-6">
            ...
            <form onSubmit={submitFormData}>
              <input
                ...
                type="text"
                className={`form-control px-5 text-black fw-bold my-2 required  ${style.main} `}
                name="name"
          ...
          <div className="col-sm-6 col-md-6 col-xl-6 col-6 mt-5">
      ...
      <div className={`mt-5 container-fluid ${style.footer}`}></div>
